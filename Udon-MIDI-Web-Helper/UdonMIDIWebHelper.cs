...
namespace Udon_MIDI_Web_Helper
{
    class UdonMIDIWebHelper
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Udon-MIDI-Web-Helper v9 Ready.  Press any key to end the program.");
            ...
            Console.WriteLine("Udon-MIDI-Web-Helper v9 Stopped.  Press any key to close this console.");
            Console.ReadKey();
        }
    }
}
