...
public class LocalStoragePersistenceExample : UdonSharpBehaviour
{
    ...
    public void Store()
    {
        ...
        webManager.StoreLocalValue(keyField.text, valueField.text, publicToggle.isOn, globalToggle.isOn);
        keyField.text = "";
        valueField.text = "";
    }
    ...
    public void Retrieve()
    {
        ...
        connectionID = webManager.RetrieveLocalValue(this, keyField.text, worldId.text);
    }
