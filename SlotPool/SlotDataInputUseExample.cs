...
public class SlotDataInputUseExample : UdonSharpBehaviour
{
    #region BaseClass
    ...
    public uint inputs;
    [UdonSynced]
    uint inputsSerializationCount;
    uint inputsDeserializationCount;
    ...
    {
        inputsDeserializationCount = inputsSerializationCount;
    }

    // Regular variable deserialization
    void _u_OnDeserialization()
    {
        if (inputsDeserializationCount != inputsSerializationCount)
        {
            inputsDeserializationCount = inputsSerializationCount;
